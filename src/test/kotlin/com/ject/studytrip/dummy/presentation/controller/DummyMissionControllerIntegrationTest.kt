...
class DummyMissionControllerIntegrationTest : BaseIntegrationTest() {
    ...
    companion object {
        private const val BASE_DUMMY_MISSION_URL = "/api/dummies/missions"
        private const val COURSE_CATEGORY = "COURSE"
        private const val EXPLORE_CATEGORY = "EXPLORE"
        private const val DUMMY_MISSION_COUNT = 10
    }
    ...
    inner class LoadDummyMissions {
        ...
        fun shouldReturnUnauthorizedWhenUnauthenticated() {
            // when
            val resultActions = getResultActions("", COURSE_CATEGORY, DUMMY_MISSION_COUNT)
        ...
        fun shouldReturnBadRequestWhenCategoryParameterTypeMismatch() {
            ...
            // when
            val resultActions = getResultActions(token, category, DUMMY_MISSION_COUNT)
        ...
        fun shouldReturnDummyMissionsWhenCategoryIsCourse() {
            // when
            val resultActions = getResultActions(token, COURSE_CATEGORY, DUMMY_MISSION_COUNT)
        ...
        fun shouldReturnDummyMissionsWhenCategoryIsExplore() {
            // when
            val resultActions = getResultActions(token, EXPLORE_CATEGORY, DUMMY_MISSION_COUNT)
