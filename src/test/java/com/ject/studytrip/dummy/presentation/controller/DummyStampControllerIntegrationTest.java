...
class DummyStampControllerIntegrationTest extends BaseIntegrationTest {
    private static final String BASE_DUMMY_STAMP_URL = "/api/dummies/stamps";
    ...
    class LoadDummyMissions {
        ...
        void shouldReturnDummyCourseStampsWhenCategoryIsCourse() throws Exception {
            // when
            ResultActions resultActions = getResultActions(accessToken, COURSE_CATEGORY, COUNT);
        ...
        void shouldReturnDummyExploreStampsWhenCategoryIsExplore() throws Exception {
            // when
